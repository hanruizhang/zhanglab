...
pbmc.data <- Read10X(data.dir = "/Users/hanruizhang/Bioinformatics/scRNA_Bootcamp_2019/Seurat/data/filtered_gene_bc_matrices/hg19")
...
VlnPlot(object = pbmc, c("percent.mito", "nCount_RNA"), nCol = 2)
...
VlnPlot(pbmc, c("nCount_RNA", "nFeature_RNA", "percent.mito","n.exp.hkgenes"), nCol = 4,  point.size.use = 0.1)
